package org.anirudh.redquark.lucenesearch.highlight;
...
public class LuceneSearchHighlighter {
	...
	public static void main(String[] args) throws Exception {
		...
		/*
		 * It scores text fragments by the number of unique query terms found. Basically
		 * the matching score in layman terms
		 */
